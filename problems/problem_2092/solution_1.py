...
class Solution:
    def findAllPeople(self, _: int, meetings: List[List[int]], firstPerson: int) -> List[int]:
        ...
        while heap:
            ...
            knows.add(cur)
            for t, d in graph[cur]:
                if d not in knows and t >= time:
...
def test_validator(inputs, expected):
    output = Solution().findAllPeople(*inputs)
